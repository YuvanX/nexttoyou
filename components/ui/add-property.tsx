...
export const AddProperty = () => {
    return <div className="flex flex-col items-center justify-center pt-28 pb-10">
        <div className="text-center text-4xl font-bold pb-5">Add New Property</div>
        <div className="space-y-5 mx-3">
                ...
                <CardContent>
                    <div className="flex gap-3 items-center">
                        <div className="w-1/2 space-y-2">
                            ...
                            <Input className="w-full" placeholder="e.g., Chotu bhai Hostel" type="text" required />
                        </div>
                        <div className="w-1/2 space-y-2">
                    ...
                    <div className="mt-5">
                        ...
                        <Textarea className="my-2" required placeholder="Describe about your property, like features etc." />
                    </div>
                </CardContent>
            </Card>
                ...
                <CardContent>
                    <div className="space-y-5">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            </div> <div className="space-y-2 w-1/3">
                                <Label>Country</Label>
                                <Input value="India" disabled placeholder="Telangana" type="text" required />
                            </div>
                        </div>
                    </div>
                </CardContent>
            ...
            <Card className="w-full md:min-w-3xl">
                <CardHeader>
                    ...
                    <CardDescription>Set your rates and room capacities</CardDescription>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardAction className="flex gap-1 items-center bg-white text-black px-4 py-1 rounded-lg text-sm"><Plus size={15} />Add Facility</CardAction>
                </CardHeader>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Upload high-quality photos of your property (up to 5 photos)</CardDescription>
                </CardHeader>
                <CardContent>
                    <FileUpload/>
                </CardContent>
